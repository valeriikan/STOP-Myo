...
public class Provider extends ContentProvider {
     ...
     */
    public static String AUTHORITY = "com.aware.app.stop_myo.model.provider.stop_myo";
    ...
    /**
     * Database stored in external folder: /package.name/stop_myo.db
     */
    public static final String DATABASE_NAME = "stop_myo.db";

    //Database table names
    public static final String DB_TBL_MYO = "myo";
    ...
    public static final class Myo_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.aware.app.stop_myo.model.provider.myo";
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.ubicomp.stopit.stopit.model.provider.myo";

        public static final String DATA = "data";
    }

    //Myo table fields
    private static final String DB_TBL_MYO_FIELDS =
            Myo_Data._ID + " integer primary key autoincrement," +
                    Myo_Data.TIMESTAMP + " real default 0," +
                    Myo_Data.DEVICE_ID + " text default ''," +
                    Myo_Data.DATA + " longtext default ''";
    ...
    public static String getAuthority(Context context) {
        AUTHORITY = context.getPackageName() + ".model.provider.stop_myo";
        return AUTHORITY;
    }
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = getContext().getPackageName() + ".model.provider.stop_myo";

        sUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);

        //Myo table indexes DIR and ITEM
        ...
        tableMyoHash.put(Myo_Data.DATA, Myo_Data.DATA);
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TABLE_MYO_DIR:
                long myo_id = database.insert(DATABASE_TABLES[0], Myo_Data.DEVICE_ID, values);
                database.setTransactionSuccessful();
                database.endTransaction();
                if (myo_id > 0) {
                    Uri dataUri = ContentUris.withAppendedId(Myo_Data.CONTENT_URI, myo_id);
